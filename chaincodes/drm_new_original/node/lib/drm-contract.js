...
class DrmContract extends Contract {
	...
	console.info('royaltyManagementAsset');
    ...
    async calcRevenue(ctx, ipiName) {
        ...
        const deltaResultsIterator = await ctx.stub.getStateByPartialCompositeKey("varName~op~value~txID", allResult)
        t=t+1
