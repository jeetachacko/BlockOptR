...
//        }
//
//	const chaincodeResponse = await ctx.stub.invokeChaincode('drmsplitb', ['InitLedger'], 'mychannel');
//        console.info('============= START : Initialize Ledger ===========');
//    }
//
...
//
//	    const chaincodeResponse = await ctx.stub.invokeChaincode('drmsplitb', ['create', [metadataId, metadata, royaltyManagementId, royaltyManagement]], 'mychannel');
//        }
//    }
//
