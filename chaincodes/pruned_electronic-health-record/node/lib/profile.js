...
class Profile {
    ...
    revokeEHRAccess(hashedKey, actorId, ehrID) {
        if (hashedKey === this.hashedKey) {
            let allEhr = this.allEhr.filter(ehr => ehr.id === ehrID);
	    let ehr = allEhr[0]
	    if ((ehr != undefined) && ehr.accessList.includes(Number.parseInt(actorId))) {
	    ...
	    /*allEhr.forEach(ehr => {
		    console.log("allEhr")
		    console.log(allEhr)
		    console.log("ehr.accessList")
		    console.log(ehr.accessList)
		    console.log("Number.parseInt(actorId)")
		    console.log(Number.parseInt(actorId))
		    console.log("ehr.accessList.includes(Number.parseInt(actorId))")
		    console.log(ehr.accessList.includes(Number.parseInt(actorId)))
		    if (ehr.accessList.includes(Number.parseInt(actorId))) {
			    console.log("In if : revokeEHRAccess")
